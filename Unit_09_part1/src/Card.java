...
public class Card {
  ...
  /**
   * Set <code>Card's</code> pointValue.
   * @param cardPointValue  a <code>int</code> value
   *                  containing the pointValue of the card
   */
  public void setPointValue(int cardPointValue){
